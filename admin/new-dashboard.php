    ...
    if (isset($_POST["id"], $_POST["message"])) {
        if (!empty($_POST["id"]) && !empty($_POST["message"])) {
            ...
            if ($response != "00") {
                ...
                header("location: $adminurl/new-dashboard.php?sender=$user");
            }
        }
    }
}
...
<body>
    ...
    <section class="">
        <nav class="abs-sidenav bg-color p-2">
            <a href="<?= $adminurl ?>/new-dashboard.php" class="d-block abs-navbrand bg-color sticky-top p-3">
                <p class="text-center mb-2 text-white">
                    <i class="fas fa-user-circle fa-4x"></i>
                </p>
                <p class="mb-0 text-center font-weight-bold text-white">Adebiyi Abdulsamod</p>
                <hr class="bg-white" />
            </a>
            ...
            <div class="abs-navcontent">
                ...
                ?>
                    <a href="<?= $adminurl ?>/new-dashboard.php?sender=<?php echo $value["user_id"]; ?>" class="card chat-box mb-2 d-flex align-items-center">
                        <p class="mb-0 card-body" id="<?= $value["user_id"] ?>">
                            <span class="">
                                <i class="fas fa-user fa-lg"></i>
                            </span>
                            <span class="font-weight-bold ml-2">USER - <?= substr($value["user_id"], 0, 20) ?></span>
